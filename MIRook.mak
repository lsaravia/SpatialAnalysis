...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=dcdflib.o ftnstop.o ipmpar.o mainMoranIRook.o MoranIRook.o\
	RWFile.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
PROG_ARGS=test.sed test.cor
SRC_DIRS=../dcdflib/src
WUC=
EDITORS=
RHIDE_OS=$(RHIDE_OS_)
ifeq ($(strip $(RHIDE_OS)),)
...
MAIN_TARGET=MIRook.exe
PROJECT_ITEMS=dcdflib.c ftnstop.c ipmpar.c mainMoranIRook.cpp\
	MoranIRook.cpp RWFile.cpp
DEFAULT_MASK=*.c
...
%.s: %.C
	$(RHIDE_COMPILE.C.s)
all::
DEPS_0= dcdflib.o ftnstop.o ipmpar.o mainMoranIRook.o MoranIRook.o RWFile.o\
...
ipmpar.o:: $(DEPS_3)
	$(RHIDE_COMPILE.c.o)
DEPS_4=mainMoranIRook.cpp
mainMoranIRook.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cpp.o)
DEPS_5=MoranIRook.cpp
MoranIRook.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cpp.o)
DEPS_6=RWFile.cpp
RWFile.o:: $(DEPS_6)
