...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=mainPairCorrelation.o pairCorrelation.o RWFile.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
PROG_ARGS=test.sed test.cor 0 200 1 BI
SRC_DIRS=
WUC=
EDITORS=
RHIDE_OS=$(RHIDE_OS_)
...
MAIN_TARGET=pCorr.exe
PROJECT_ITEMS=mainPairCorrelation.cpp pairCorrelation.cpp RWFile.cpp
DEFAULT_MASK=*.cpp
...
%.s: %.C
	$(RHIDE_COMPILE.C.s)
all::
DEPS_0= mainPairCorrelation.o pairCorrelation.o RWFile.o 
NO_LINK=
LINK_FILES=$(filter-out $(NO_LINK),$(DEPS_0))
pCorr.exe:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=mainPairCorrelation.cpp
mainPairCorrelation.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cpp.o)
DEPS_2=pairCorrelation.cpp
pairCorrelation.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
DEPS_3=RWFile.cpp
RWFile.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cpp.o)
